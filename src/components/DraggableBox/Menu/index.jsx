        ...
        {readMore &&
          <div className={styles.content}>
            ...
            <div className={styles.title}>
              <h3>في قلب الهفوف بمنطقة الأحساء، وتحديدًا في حي الكوت، يقع بيت البيعة (بيت الملَّا)، الذي يعد من أهم المعالم التي شهدت أحداثًا تتعلق بتاريخ المملكة العربية السعودية.</h3>
            </div>
