        ...
        {readMore && (
          <div className={styles.content}>
            ...
            {/* <div className={styles.desc}>
              <p>
                {" "}
                ففي يوم الأحد، ليلة الاثنين 28 / 5 / 1331هـ، استقبل هذا البيت
                الملكَ المؤسس عبدالعزيز بن عبدالرحمن آل سعود رحمه الله، بعد
                وصوله إلى الأحساء، وجرت فيه مبايعة أهالي الأحساء له.
              </p>
            </div>

            <div className={styles.title}>
              <h3>
                ويعود تاريخ بناء "بيت البيعة" إلى عام 1203هـ، وقد قام ببنائه
                الشيخ عبدالرحمن بن عمر بن محمد بن عمر المُلَّا، الذي كان يشغل
                منصِب قاضي الأحساء في تلك الفترة.
              </h3>
            </div>

            <div className={styles.desc}>
              <p>
                ويمتد هذا البيت على مساحةٍ تزيد على 705م2، وهو يحتوي على العديد
                من الغرف، ويضم مقتنياتٍ أثرية ومخطوطاتٍ قديمة، مما يجعله شاهدًا
                على الحقبة التاريخية التي بُني فيها. وبجهود من هيئة التراث، تم
                ترميم بيت البيعة، وتحويله إلى موقعٍ تاريخي، وأصبح اليوم معلَمًا
                أثريًّا وسياحيًّا بارزًا من معالم الأحساء، يجذب الزوار الراغبين
                في التعرف على تلك المرحلة من تاريخ المنطقة.
              </p>
            </div> */}
